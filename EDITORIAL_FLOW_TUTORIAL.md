...
O **Bibline Editorial Framework (BEF)** é um sistema completo de produção, gestão e publicação de conteúdo educacional para a Bibline Academy. Ele integra:
...
### bef/ - Bibline Editorial Framework (Canonical Reference)
...
**Triggers**:
- Push para branch `main` (paths: `*.html`, `public/**`, `assets/**`)
...
| **Image Generator** | Skill separada em `bef/agents/skills/image-generator/` (usa Pollinations.ai, HuggingFace, DeepAI APIs) |
