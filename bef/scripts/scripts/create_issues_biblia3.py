...
md_path = "/home/italo.gabriel/Documents/Developer/Projeto-Editorial-Education/Projeto Bibline Academy/Belas Artes - Fase da Gramática/0-Descrições e criação de tickets para as disciplinas/Em-Progresso/biblia-3-ano.md"

tickets = []
with open(md_path) as f:
    content = f.read()

# Split on --- separator and extract tickets
blocks = content.split("\n---\n")
ticket_re = re.compile(r"^\[Bíblia\] - Ano 3 - (.+?)\n\n# Description\n\n(.+?)$", re.DOTALL)
...
for block in blocks:
    ...
    if m:
        ...
        full_title = f"[Bíblia] - Ano 3 - {ticket_id_title}"
