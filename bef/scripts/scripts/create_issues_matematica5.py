...
md_path = "/home/italo.gabriel/Documents/Developer/Projeto-Editorial-Education/Projeto Bibline Academy/Belas Artes - Fase da Gramática/0-Descrições e criação de tickets para as disciplinas/Em-Progresso/matematica-5-ano.md"
...
ticket_re = re.compile(r"^\[Matemática\] - Ano 5 - (.+?)\n\n# Description\n\n(.+?)$", re.DOTALL)
...
for block in blocks:
    ...
    if m:
        ...
        full_title = f"[Matemática] - Ano 5 - {ticket_id_title}"
