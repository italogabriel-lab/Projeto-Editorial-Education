...
### **Agent Responsável**
- **Agente:** `image-generator` (trivium-method/agents/skills/image-generator/)
...
- Verificar com: `python trivium-method/scripts/image-generation/list_models.py`
...
| Arquivo | Propósito |
|---------|-----------|
| `trivium-method/scripts/image-generation/generate_image.py` | Script principal (Gemini) |
| `trivium-method/scripts/image-generation/generate_image_temp.py` | Script temporário (Pollinations) |
| `trivium-method/scripts/image-generation/test_gemini_quick.py` | Teste rápido |
| `trivium-method/scripts/image-generation/diagnose_gemini_api.py` | Diagnóstico |
| `trivium-method/scripts/image-generation/list_models.py` | Listar modelos |
...
4. GERAR
   ├── Gemini: python trivium-method/scripts/image-generation/generate_image.py
   └── Pollinations: python trivium-method/scripts/image-generation/generate_image_temp.py
