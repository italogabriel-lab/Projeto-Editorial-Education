...
### 8.1.2 Regra Obrigatoria — Campo `# Description` nos Tickets

> **⚠️ REGRA DE OURO:** Ao criar tickets no Kanban do GitHub, o corpo de cada ticket DEVE conter obrigatoriamente o cabeçalho `# Description` seguido da descricao do conteudo. Este campo faz parte da estrutura padrao do ticket e **NAO pode ser omitido**.

**Estrutura padrao de cada ticket:**
...
Descricao do conteudo da aula/revisao/prova
```

**Aplicacao:** Esta regra vale para TODOS os tipos de tickets:
- Aulas regulares (.1, .2, .3)
- Revisoes semanais (.4)
- Provas semanais (.5)
- Revisoes bimestrais (semanas 9, 19, 29, 39)
- Provas bimestrais (semanas 10, 20, 30, 40)

**Referencia:** Consulte o arquivo de exemplo em `Descricoes e criacao de tickets para as disciplinas/Em-Progresso/ciencias-4-ano.md` para o padrao completo.
