...
- Revisão bimestral `9.md`, `19.md`, `29.md`, `39.md`: usar 8 blocos semanais com `# [nome da aula .1]`, parágrafo `Nesta semana estudamos que **...**`, `[+HEADING] Atividade`, `[+IMAGE_TEXT_ON]` com `@link_png@`, `@link_mp3@` e o nome da aula `.1`. O quiz final é `## [QUIZ] Questões` com exatamente 8 `[+FILL_IN]`, um por semana, copiados das revisões `.4`.
