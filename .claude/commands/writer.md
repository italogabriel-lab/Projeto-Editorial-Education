...
- Em `x.2` e `x.3`, **só varia a explicação da palavra-chave** (e a explicação no Accordion). A definição curta em negrito é literal de `x.1`, e o parágrafo livre deve usar palavras-chave do tema central.
