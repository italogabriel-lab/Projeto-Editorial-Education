...
```bash
python scripts/main.py generate 3 --output generated/imagens-narrar/3-ano/
```
...
```bash
# Ver estrutura
tree generated/imagens-narrar/3-ano/ -L 2

# Ver log
cat generated/imagens-narrar/3-ano/LOG.md
```

**Estrutura Esperada:**
```
generated/imagens-narrar/3-ano/
├── semana-1/
│   ├── 1.1_narrar.png
│   ├── 1.1_narrar_prompt.txt
│   └── ...
...
mkdir -p generated/imagens-narrar/3-ano
chmod 755 generated/imagens-narrar/3-ano
...
```bash
# Após gerar tudo
cp -r generated/imagens-narrar/3-ano/ backup/imagens-narrar-3-ano/
```
