...
| Quero... | Vá Para |
|----------|---------|
| **Gerar uma imagem agora** | `trivium-method/scripts/image-generation/generate_image_temp.py` |
| **Entender o fluxo completo** | `trivium-method/agents/skills/image-generator/IMAGE-GENERATION-WORKFLOW.md` |
| **Configurar API Gemini** | `trivium-method/agents/skills/image-generator/README.md` |
| **Ver padrão de organização** | `[Ano]/2 - Imagens/PADRAO_IMAGENS.md` |
| **Início rápido (5 min)** | `trivium-method/agents/skills/image-generator/QUICKSTART.md` |
...
2. Configurar API Key (opcional)
   → trivium-method/agents/skills/image-generator/README.md
...
1. Ler workflow completo
   → trivium-method/agents/skills/image-generator/IMAGE-GENERATION-WORKFLOW.md
...
2. Ver documentação de erros comuns
   → trivium-method/agents/skills/image-generator/README.md#troubleshooting

3. Verificar lista de modelos
   → python trivium-method/scripts/image-generation/list_models.py
```
...
| 2026-04-06 | Scripts movidos | Todos em `trivium-method/scripts/image-generation/` |
