...
Toda a documentação sobre geração de imagens foi **centralizada e organizada** no agente especializado `trivium-method/agents/skills/image-generator/`, eliminando redundâncias e estabelecendo um fluxo de trabalho claro e documentado.
...
4. GERAR
   → Python trivium-method/scripts/image-generation/generate_image.py
...
✅ **Encontrar documentação** → Ir direto ao agente `trivium-method/agents/skills/image-generator/`  
✅ **Gerar imagens** → Scripts em `trivium-method/scripts/image-generation/`  
...
✅ **Adicionar scripts** → Adicionar em `trivium-method/scripts/image-generation/`  
...
|---------|-------------|-----------|
| `README.md` | `trivium-method/agents/skills/image-generator/` | Doc principal do agente |
| `QUICKSTART.md` | `trivium-method/agents/skills/image-generator/` | Guia de 5 minutos |
| `IMAGE-GENERATION-WORKFLOW.md` | `trivium-method/agents/skills/image-generator/` | Fluxo completo |
...
| Recurso | Caminho |
|---------|---------|
| **Agente de Geração** | `trivium-method/agents/skills/image-generator/` |
| **Scripts** | `trivium-method/scripts/image-generation/` |
| **Workflow** | `trivium-method/agents/skills/image-generator/IMAGE-GENERATION-WORKFLOW.md` |
