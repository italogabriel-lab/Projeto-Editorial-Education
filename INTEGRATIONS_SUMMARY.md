...
└── assets/imagens-narrar/          # Imagens geradas
    └── [ANO]-ano/semana-[N]/
```
...
### Agentes:
- `bef/agents/skills/*/SKILL.md` - Definição de cada agente (20 files)
- `bef/agents/skills/*/README.md` - Documentação de cada agente
- `editorial-squad/AGENTS-DOCUMENTATION.md` - Índice mestre

### Workflows:
- `bef/workflows/workflows/produce_class.md` - Pipeline de 7 etapas
- `bef/workflows/workflows/publish.md` - Workflow de publicação
- `bef/workflows/workflows/orchestrate.md` - Workflow do Orchestrator

### Knowledge Base:
- `bef/knowledge-base/knowledge-base/visao-geral-fluxo-editorial.md` - Visão geral (572 linhas)
- `bef/knowledge-base/knowledge-base/doutrina-pedagogica.md` - Doutrina pedagógica
- `bef/knowledge-base/knowledge-base/guia-de-estilo.md` - Guia de estilo
- `bef/knowledge-base/knowledge-base/rise-blocks-reference.md` - Referência Rise Blocks
