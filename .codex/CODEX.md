...
- **Revisão bimestral**: arquivos `9.md`, `19.md`, `29.md` e `39.md` usam 8 blocos, um por semana, cada um com `# [nome da aula .1]`, parágrafo `Nesta semana estudamos que **...**`, `[+HEADING] Atividade` e `[+IMAGE_TEXT_ON]`. O quiz final tem exatamente 8 `[+FILL_IN]`, um por semana, copiados das revisões `.4`.
