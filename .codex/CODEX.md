...
- Manter o Accordion do Definir nos anos 1, 3, 4 e 5, ou os TABS no 2º ano, com tema ou pergunta simples, `@link_png@`, MP3 com definição curta, explicação completa e conexão teológica na mesma linha, separadas por espaço, e texto visual equivalente após `[MP3\]`. Aplicar a mesma linha única ao áudio do Narrar.
