## Padrões para que todos os arquivos estejam com os titulos sincronizados e atualizado - Rodar sincronização - Titulos corrigidos [Pendente]

rodar uma sincronização local baseada no currículo macro do 2º ano. Ela vai trocar apenas campos de título identificados por número de aula, em matriz, visão pedagógica e H1 dos arquivos de aula existentes

faça isso para os arquivos do 1 ANO 
...
## Padrões para os arquivos de Matriz Curricular - objetivos e Visão e plano pedagoico [Pendente]

ANALISE OS ARQUIVO DO 1 ANO 

/home/italo.gabriel/Documents/Developer/Projeto-Editorial-Education/Projeto - Bibline Academy ( Produção de Aulas)/Belas Artes - Fase da Gramática/1 Fase - Gramática/1º Ano/Estrutura Curricular - 1º ANO/1 - Curriculo Macro - 1º ANO.md
/home/italo.gabriel/Documents/Developer/Projeto-Editorial-Education/Projeto - Bibline Academy ( Produção de Aulas)/Belas Artes - Fase da Gramática/1 Fase - Gramática/1º Ano/Estrutura Curricular - 1º ANO/2 - Matriz-Curricular-objetivos - 1º ANO.md
/home/italo.gabriel/Documents/Developer/Projeto-Editorial-Education/Projeto - Bibline Academy ( Produção de Aulas)/Belas Artes - Fase da Gramática/1 Fase - Gramática/1º Ano/Estrutura Curricular - 1º ANO/3 - Visão e Plano pedagogico - 1º ANO.md

E APLIQUE ESSE MESMO PADRÃO PARA O 2 ANO 

USANDO O 1 - Curriculo Macro - Da criação até a Arte Bizantina - 2º ANO COMO A FONTE PARA AJUSTAR OS OUTROS ARQUIVOS  ,POR QUE ESSE É O NOVO MACRO COM A ADEQUADAÇÃO DOS TITULOS 

com base nesse arquivo replique a mesma abordagem que foi aplicada no 1 ano para cirar os arquivos seguindo  o padrão que aconteceu no 1 ano 


replique nos arquivo s do  2 ano 