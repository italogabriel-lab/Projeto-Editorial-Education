## Padrões para que todos os arquivos estejam com os titulos sincronizados e atualizado - Rodar sincronização - Titulos corrigidos
...
## Padrões para os arquivos de Matriz Curricular - objetivos e Visão e plano pedagoico 
