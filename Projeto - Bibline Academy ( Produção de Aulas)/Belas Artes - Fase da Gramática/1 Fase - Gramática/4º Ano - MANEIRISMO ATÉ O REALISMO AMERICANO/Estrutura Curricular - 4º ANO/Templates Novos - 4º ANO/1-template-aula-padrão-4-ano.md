...
[UMA ÚNICA FRASE direta e objetiva para explicar a palavra-chave. Negritos progressivos: em x.1 somente o **TERMO** em negrito; em x.2 o **TERMO** e a **KW2** (= resposta do fill-in de x.2); em x.3 o **TERMO** e a **KW3** (= resposta do fill-in de x.3).]
...
[Explicação da palavra-chave com negritos progressivos e conexão teológica, literalmente idênticas ao Definir.]
...
[Frase curta para orientar a observação da imagem.]
...
[Definição curta da semana com _____ na palavra-chave desta aula. x.1: lacuna no TERMO. x.2: lacuna na KW2. x.3: lacuna na KW3.]
...
[Pergunta derivada do parágrafo livre desta aula. Deve diferir entre x.1, x.2 e x.3. Formatos válidos: "O que [TERMO] [VERBO]?", "Como [TERMO] [VERBO]?", "Onde [TERMO] aparece?", "Para que [TERMO] [VERBO]?", "Quando [TERMO] [VERBO]?", "Quais [ELEMENTOS]?"]
