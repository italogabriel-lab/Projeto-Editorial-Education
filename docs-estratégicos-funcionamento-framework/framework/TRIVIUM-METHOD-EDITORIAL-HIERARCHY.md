# Trivium Method Editorial Hierarchy

## Hierarquia estrutural

```text
Trivium Method Editorial
├── .trivium-method-editorial-core/            -> governanca, registries, wrappers, workflows, checklists
├── trivium-method-editorial/                  -> biblioteca editorial compartilhada
