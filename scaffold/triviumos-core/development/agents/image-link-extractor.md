...
persona:
  ...
  identity: "Wrapper do TriviumOS para o skill canônico Image Link Extractor"
...
dependencies:
  canonical_skill: "triviumos/agents/skills/image-link-extractor/SKILL.md"
  canonical_docs: "triviumos/agents/skills/image-link-extractor/README.md"
  workflows:
    - "class-production"
  handoff:
    - "image-generator"
...
- Category: `legacy`
- Status: `legacy`
- Canonical source: `triviumos/agents/skills/image-link-extractor/SKILL.md`
