...
persona:
  ...
  identity: "Wrapper do TriviumOS para o skill canônico Review Builder"
...
dependencies:
  canonical_skill: "triviumos/agents/skills/review-builder/SKILL.md"
  canonical_docs: "triviumos/agents/skills/review-builder/README.md"
  workflows:
...
- Category: `legacy`
- Status: `legacy`
- Canonical source: `triviumos/agents/skills/review-builder/SKILL.md`
