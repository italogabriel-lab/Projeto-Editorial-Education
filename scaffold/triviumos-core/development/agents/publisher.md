...
persona:
  ...
  identity: "Wrapper do TriviumOS para o skill canônico Publisher"
...
dependencies:
  canonical_skill: "triviumos/agents/skills/publisher/SKILL.md"
  canonical_docs: "triviumos/agents/skills/publisher/README.md"
  workflows:
    - "publish-release"
  handoff:
    - "devops"
...
- Category: `core`
- Status: `active`
- Canonical source: `triviumos/agents/skills/publisher/SKILL.md`
