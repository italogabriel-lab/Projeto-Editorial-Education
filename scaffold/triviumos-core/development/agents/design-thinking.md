...
persona:
  ...
  identity: "Wrapper do TriviumOS para o skill canônico Design Thinking"
...
dependencies:
  canonical_skill: "triviumos/agents/skills/design-thinking/SKILL.md"
  canonical_docs: "triviumos/agents/skills/design-thinking/README.md"
  workflows:
...
- Category: `enablement`
- Status: `active`
- Canonical source: `triviumos/agents/skills/design-thinking/SKILL.md`
