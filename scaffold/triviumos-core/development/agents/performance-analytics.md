...
persona:
  ...
  identity: "Wrapper do TriviumOS para o skill canônico Performance Analytics"
...
dependencies:
  canonical_skill: "triviumos/agents/skills/performance-analytics/SKILL.md"
  canonical_docs: "triviumos/agents/skills/performance-analytics/README.md"
  workflows:
...
- Category: `analytics`
- Status: `active`
- Canonical source: `triviumos/agents/skills/performance-analytics/SKILL.md`
