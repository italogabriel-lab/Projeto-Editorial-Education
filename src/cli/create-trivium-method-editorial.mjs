...
function parseArgs(argv) {
  ...
  options.targetDir = options.targetDir || "trivium-method-editorial-workspace";
  return options;
}
...
export async function main() {
  ...
  console.log("Trivium Method Editorial");
  ...
  console.log("  npm run trivium-method-editorial:inventory");
  console.log("  npm run trivium-method-editorial:doctor");
}
