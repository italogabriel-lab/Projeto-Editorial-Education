# TriviumOS Adjustments

## Ajustes realizados

1. O fluxo editorial foi reorganizado em uma arquitetura inspirada no AIOX.
2. Foi criado o pacote `create-triviumos`; o comando publico `npx create-triviumos` ainda depende de publicacao no npm.
3. Os ativos editoriais foram inventariados em um registry central.
4. Foram gerados wrappers de agentes em `.triviumos-core/development/agents/`.
...
3. Os workflows do GitHub exigem:
   - secret `TRIVIUMOS_GITHUB_TOKEN`
   - variable `TRIVIUMOS_PROJECT_ID`
